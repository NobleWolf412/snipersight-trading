...
class CycleContext:
    ...
    # Cycle failure flags (populated from symbol_cycle_detector — more reliable than price comparison)
    # dcl_failed = price broke below the cycle low → short-term trend reversal confirmed
    # wcl_failed = price broke below the weekly cycle low → macro trend reversal confirmed
    dcl_failed: bool = False
    wcl_failed: bool = False
