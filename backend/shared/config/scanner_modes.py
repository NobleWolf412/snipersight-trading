...
MODES: Dict[str, ScannerMode] = {
    "overwatch": ScannerMode(
        ...
        min_confluence_score=74.0,  # CALIBRATED: 72→78→74 — 78 was too high given structural overhead (coverage penalty, cycle gates) that stack 16-44pts of drag before SMC factors score
    ...
    "surgical": ScannerMode(
        ...
        min_confluence_score=72.0,  # LOWERED: 75->72 to allow pure scalp setups missing HTF regime alignment
        profile="precision",
