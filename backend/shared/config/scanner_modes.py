...
MODES: Dict[str, ScannerMode] = {
    ...
    "strike": ScannerMode(
        ...
        min_confluence_score=62.0,  # LOWERED: 70->62 to allow aggressive intraday setups to pass
    ...
    "surgical": ScannerMode(
        ...
        min_confluence_score=65.0,  # LOWERED: 72->65 to allow precision scalps missing HTF regime
        profile="precision",
    ...
    "stealth": ScannerMode(
        ...
        min_confluence_score=65.0,  # LOWERED: 70->65 for better balanced flow with new scoring
