...
class PlannerConfig:
    ...
    atr_regime_thresholds: Dict[str, float] = field(
    ...
    stop_buffer_by_regime: Dict[str, float] = field(
        default_factory=lambda: {
    ...
    htf_bias_offset_min_factor: float = (
    ...
    htf_swing_allowed: Dict[str, tuple] = field(
        default_factory=lambda: {
    ...
    price_alignment_max_rel_diff: float = (
        0.5  # Max relative diff between mid_entry and current_price
    )
    ...
    def defaults_for_mode(cls, mode: str) -> "PlannerConfig":
        ...
        if mode_lower in ("scalp", "precision"):
            return cls(
                ...
                htf_bias_offset_min_factor=0.4,  # Less aggressive HTF bias for scalps
            )
            ...
            return cls(
                ...
                htf_bias_offset_min_factor=0.2,  # More aggressive HTF bias for swing
            )
