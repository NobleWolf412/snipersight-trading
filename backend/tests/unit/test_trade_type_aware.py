...
import pytest
from backend.shared.config.scanner_modes import get_mode, MODES, ScannerMode
from backend.shared.config.rr_matrix import validate_rr, get_rr_threshold
...
class TestScannerModeTradeTypes:
    ...
    def test_all_modes_have_valid_trade_type(self):
        ...
        for name, mode in MODES.items():
            assert mode.expected_trade_type in valid_types, f"Mode {name} has invalid trade type: {mode.expected_trade_type}"
