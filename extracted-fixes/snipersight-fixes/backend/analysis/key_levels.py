...
def _update_level_status(level: KeyLevel, current_price: float, is_high: bool, sweep_threshold: float = 0.001):
    """
...
def get_nearest_level(levels: KeyLevels, current_price: float, direction: str = 'both') -> Optional[KeyLevel]:
    """
