            ...
            >
              ...
              <TacticalCard
                ...
                className={`cursor-pointer ${
                  isSelected
                    ? `bg-[oklch(0.28_0.012_120)] ${borderClass} shadow-lg transform scale-[1.02] border-2`
                    : 'bg-[oklch(0.16_0.006_110)] hover:bg-[oklch(0.22_0.010_120)] hover:border-border hover:scale-[1.01] border'
                } ${textEffect}`}
              >
