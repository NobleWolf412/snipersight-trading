              ...
              <div className="relative group">
                ...
                <div className="relative p-8 md:p-10 rounded-2xl backdrop-blur-sm card-3d">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl md:text-3xl font-bold mb-2 heading-hud">TRAINING GROUND</h3>
                      <p className="text-sm text-warning font-mono tracking-wider heading-hud">SIMULATION MODE</p>
                    </div>
                  </div>
                  
                  <p className="text-muted-foreground leading-relaxed mb-10">Practice with simulated market data in a risk-free environment. Master the system's features, test strategies, and build confidence before deploying real capital.</p>
