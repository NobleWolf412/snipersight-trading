        ...
        <PageShell>
          <div className="space-y-10 md:space-y-12">
            <div className="space-y-3">
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight heading-hud">Autonomous Bot Configuration</h1>
            ...
            <div className="card-3d p-6 space-y-6">
              <h2 className="text-xl font-semibold heading-hud">Coming Soon</h2>
