...
function getModeRecommendation(modeName: string, regime: string | null): { recommended: boolean; reason: string } {
    ...
    if (regimeLower.includes('up') || regimeLower.includes('down') || regimeLower.includes('trend') || regimeLower.includes('expansion')) {
    ...
    if (regimeLower.includes('volatile') || regimeLower.includes('chaotic') || regimeLower.includes('explosive')) {
