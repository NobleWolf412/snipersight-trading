import { ArrowRight, TrendUp, TrendDown, Crosshair, Target, Shield, ChartLine, Stack, Info } from '@phosphor-icons/react';
            ...
            {result.rationale && (
                <div className="mt-4 pt-4 border-t border-zinc-800/40">
                    <div className="flex items-start gap-3">
                        <Info size={16} className="text-[#00ff88]/60 mt-0.5 flex-shrink-0" />
