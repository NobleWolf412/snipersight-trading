...
export interface ScanResult {
  ...
  // High-level metadata for expanded views
  trade_type?: string;
  regime_label?: string;
}
...
export function convertSignalToScanResult(signal: any): ScanResult {
  ...
  return {
    ...
    // Trade classification metadata for expanded view
    trade_type: signal.trade_type || undefined,
    regime_label: signal.regime_label || signal.atr_regime?.label || undefined,
  };
}
