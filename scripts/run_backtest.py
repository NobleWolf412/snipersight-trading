...
def run_backtest(
    ...
    print(f"\n🎯 Running scanner on current data...")
    print(f"   ⚠️  NOTE: This is a forward-test snapshot, not a true historical backtest.")
    print(f"   ⚠️  Scanner runs ONCE at current time. Use walk_forward_backtest() for multi-window testing.")
